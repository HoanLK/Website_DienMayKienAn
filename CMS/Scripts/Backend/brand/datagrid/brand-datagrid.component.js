import templateUrl from "./brand-datagrid.component.html";

export default class BrandDatagridController {
  constructor($scope, CommonService, DevextremeService, BrandService) {
    "ngInject";
    ...
    this.datagrid = angular.extend(this.devextremeService.getDefaultGrid(), {
      ...
      dataSource: this.brandService.gets([
        "Id",
        "Image",
        "Name",
        "Image",
  ...
  // CREATE
  onCreate() {
    this.brandService.redirectCreate();
  }

  // EDIT
  onEdit(id) {
    this.brandService.redirectEdit(id);
  }
...
BrandDatagridController.$inject = [
  "$scope",
  "CommonService",
  "DevextremeService",
  "BrandService",
...
export const BrandDatagridComponent = {
  template: templateUrl,
  controller: BrandDatagridController,
};
