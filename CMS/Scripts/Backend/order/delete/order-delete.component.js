import templateUrl from "./order-delete.component.html";

export default class OrderDeleteController {
  constructor($timeout, DevextremeService, OrderService) {
    "ngInject";
...
OrderDeleteController.$inject = [
  "$timeout",
  "DevextremeService",
  "OrderService",
];

export const OrderDeleteComponent = {
