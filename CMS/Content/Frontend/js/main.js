(function ($) {
     ...
     * Read More
     ***********************/
    $("#tech-info-body-1").readmore({
        speed: 75,
        collapsedHeight: 350,
        moreLink: '<div class="row"><div class="col-md-12 text-center m-t-30"><a class="btn btn-primary" title="Xem thêm" href="#">Xem thêm <i class="fas fa-angle-down"></i></a></div></div>',
        lessLink: '<div class="row"><div class="col-md-12 text-center m-t-30"><a class="btn btn-primary" title="Thu gọn" href="#">Thu gọn <i class="fas fa-angle-up"></i></a></div></div>',
    });
    $("#tech-info-body-2").readmore({
        speed: 75,
        collapsedHeight: 350,
        moreLink: '<div class="row"><div class="col-md-12 text-center m-t-30"><a class="btn btn-primary" title="Xem thêm" href="#">Xem thêm <i class="fas fa-angle-down"></i></a></div></div>',
        lessLink: '<div class="row"><div class="col-md-12 text-center m-t-30"><a class="btn btn-primary" title="Thu gọn" href="#">Thu gọn <i class="fas fa-angle-up"></i></a></div></div>',
        ...
        if ($lis.length > 0) {
            $ul.append(
                $(
                    '<li class="expand">' +
                    (isExpanded
                        ? '<a href="javascript:;"><span><i class="icon-minus-square"></i>Bớt danh mục</span></a>'
                        : '<a href="javascript:;"><span><i class="icon-plus-square"></i>Thêm danh mục</span></a>') +
                    "</li>"
    ...
    $("#more-btn").on("click", function (e) {
        ...
        var htmlAfter =
            '<i class="ion-ios-minus-empty" aria-hidden="true"></i> Bớt danh mục';
        var htmlBefore =
            '<i class="ion-ios-plus-empty" aria-hidden="true"></i> Thêm danh mục';
     ...
     ******************************************************/
    var productDefaultSlider5Grid2Row = new Swiper(
        ".product-default-slider-5grid-2row",
        {
            slidesPerView: 5,
            spaceBetween: 0,
            speed: 500,
     ...
     ******************************************************/
    var productDefaultSlider4Grid2Row = new Swiper(
        ".product-default-slider-4grid-2row",
        {
            slidesPerView: 4,
            spaceBetween: 0,
            speed: 500,
